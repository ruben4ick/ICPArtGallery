    ...
    return (
        <>
            <div className="glass w-[380px] rounded-lg overflow-hidden flex flex-col">
                ...
                <button className="card-btn details-btn mt-[16px] mb-[4%] mx-[4%]" onClick={() => setIsModalOpen(true)} type="button">
                    .details
                </button>
            </div>

            {isModalOpen ? <div className="fixed w-full h-full flex items-center justify-center inset-0 z-99">
