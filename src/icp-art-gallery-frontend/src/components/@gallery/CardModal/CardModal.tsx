    ...
    return (
        <div className="glass modal-glass w-[960px] rounded-lg overflow-hidden p-6 relative grid grid-cols-[60%_auto] grid-rows-[auto_auto] gap-4">
            ...
            <div className="modal-description col-start-2 row-end-2 pt-5">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus distinctio doloremque est illum incidunt nisi sequi sint, vitae. Animi, beatae doloremque ea ex fuga fugiat nisi porro temporibus tenetur vel.</p>
            </div>
