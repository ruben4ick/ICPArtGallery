  ...
  return (
    <div className="glass modal-glass w-[960px] rounded-lg flex flex-col">
      ...
      <div className="flex flex-col mx-[6%] mt-[8%] mb-[6%] gap-3">
        <input className="modal-text-input p-3 rounded-lg" placeholder=".title" type="text" />
        <textarea
          className="modal-text-input p-3 rounded-lg outline-none min-h-[120px]"
          placeholder=".description"
        />
        {/*add onClick={handleDropZoneClick}*/}
        <div className="flex flex-col items-center justify-center border-2 border-dashed border-white/30 rounded-lg p-6 cursor-pointer hover:bg-white/5 transition">
